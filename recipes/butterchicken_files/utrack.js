...
if (!newskey.utrack_loaded || false) {
  newskey.geo = {};  utag_data.newskey_geo_country = newskey.geo.country="AU".toLowerCase();   utag_data.newskey_geo_region = newskey.geo.region= "QLD".toLowerCase();   utag_data.newskey_geo_city = newskey.geo.city= "BRISBANE".toLowerCase();   utag_data.newskey_geo_lat = newskey.geo.lat= "-27.50".toLowerCase();   utag_data.newskey_geo_long = newskey.geo.long= "153.02".toLowerCase();   utag_data.newskey_geo_tmz = newskey.geo.tmz= "GMT+10".toLowerCase();   utag_data.newskey_geo_network = newskey.geo.network= "optus".toLowerCase();  
  (function(){
